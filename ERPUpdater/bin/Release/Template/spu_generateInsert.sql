...
SET @table='{#Table}'
SET @restriction ='{#clause}'

SET @table='syMapping'
SET @restriction = 'CompanyID=10'
--AS

/*******************************************************************************
SET @table='SYProviderField'
SET @restriction = 'CompanyID=11 and providerID=''00010DC9-9F8A-4EB6-A197-EF87E4A97422''' 
SET @table='SYProviderParameter'
SET @restriction = 'CompanyID=11 and providerID=''00010dc9-9f8a-4eb6-a197-ef87e4a97422''' 
...
BEGIN
           ...
           BEGIN
                 ...
                 BEGIN                                            
                       ...
                       BEGIN					
						   ...
						   --DNH 
						   INSERT INTO #TempData(MyInst) values (@statementToOutput)
     ...
     BEGIN
           PRINT '-- ** WARNING:  444 There is an image column in your table which has not been migrated - this has been replaced with NULL.  You will need to do this by hand.  Images are not supported by this script at this time.  ** --'
     END
